...
encodePreOpenAcc options encodeAcc pacc =
  ...
  case pacc of
    ...
    GradientA _ _ f a            -> intHost $(hashQ "GradientA")   <> travAF f <> travA a
...
encodeOpenExp exp =
  ...
  case exp of
    ...
    GradientE tp t f e          -> intHost $(hashQ "GradientE")   <> encodeTypeR tp <> encodeScalarType t <> travF f  <> travE e
