...
manifest config (OpenAcc pacc) =
  ...
  Manifest $ case pacc of
    ...
    Avjp t t' f a b         -> Avjp t t' (cvtAF f) (manifest config a) (manifest config b)
...
embedPreOpenAcc config matchAcc embedAcc elimAcc pacc
  ...
  $ case pacc of
    ...
    Avjp t t' f a b     -> done $ Avjp t t' (cvtAF f) (cvtA a) (cvtA b)
  ...
  where
    ...
    replaceE sh' f' avar@(Var (ArrayR shR _) _) exp =
      case exp of
        ...
        Evjp t t' f e a                 -> Evjp t t' (replaceF sh' f' avar f) (replaceE sh' f' avar e) (replaceE sh' f' avar a)
    ...
    replaceA sh' f' avar pacc =
      case pacc of
        ...
        Avjp t t' f a b         -> Avjp t t' (cvtAF f) (cvtA a) (cvtA b)
